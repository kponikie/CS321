    ...
    <div id="divReservation">
        ...
        <div id="ReservationData2" runat="server" visible="false">
            ...
            <div id="ReservationData3" runat="server" visible="false">
                ...
                <asp:TextBox ID="txtReturnDate" runat="server" Width="80px" ReadOnly="true" ToolTip="Automatically Calculated Date" Enabled="false" SkinID="BlueTextBox"></asp:TextBox>&nbsp
                <br />
                <asp:Label ID="lblReturnTime" runat="server" Text="Time: "></asp:Label>
                <asp:TextBox ID="txtReturnTime" runat="server" Width="80px" ReadOnly="true" ToolTip="Automatically Calculated Time" Enabled="false" SkinID="BlueTextBox"></asp:TextBox>&nbsp
                <br /><br />
                ...
                <asp:DropDownList ID="ddlCupon" runat="server" Width="200px" Enabled="false" ToolTip="Discount %%%" OnSelectedIndexChanged="ddlCupon_SelectedIndexChanged" SkinID="BlueTextBox"></asp:DropDownList>
